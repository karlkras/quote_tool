...
<body>
<p><a href="index.php">Index</a> &gt; Target Languages</p><br />
...
while ($res =  $result->fetch_assoc())
{
	...
	echo "<tr><td><span id=\"name-".$id ."\">". $name . "</span></td><td><a href=\"#\" onClick=\"return editTarget('". $id ."');\"><img src=\"images/Edit-icon.png\" alt=\"Edit\" border=0 title=\"Edit\" /></a></td>\n";
			
	$delRow = $rowCount+1;
	print("	<td><a href=\"#\" onClick=\"return deleteTarget( this.parentNode.parentNode, '". $id ."');\"><img src=\"images/delete-icon.png\" alt=\"Delete\" border=0 title=\"Delete\"/></a></td>\n</tr>\n\n");
...
<tr>
	...
	<tr>
		<td colspan="2" align="center"><a href="#" onclick=" addTarget(); return popup('popUpDiv');">Add Language</a></td>
	</tr>
</table>
</form>
</div>
